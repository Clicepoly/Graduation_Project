...
class VivifrailRepository {
    ...
    private fun getBWheelExercises(week: Int): List<Exercise> {
        return listOf(
            //getBWalkingExercise(week), //步行被審略
            // 往上伸展手臂、模擬坐下、椅上伸展手臂有換順序
            Exercise("B1", "往上伸展手臂", "輕鬆", "3組", "3次(維持10-12秒)", "休息30秒"),
            Exercise("B2", "模擬坐下動作", "中等", "3組", "12次", "休息1分鐘"),
            Exercise("B3", "椅上伸展手臂", "輕鬆", "3組", "3次(維持10-12秒)", "休息30秒"),
            Exercise("B4", "舉水瓶", "中等", "3組", "12次", "休息1分鐘"),
            Exercise("B5", "擠壓球", "輕鬆", "3組", "12次", "休息1分鐘"),
            Exercise("B6", "用腳尖、腳跟走路", "中等", "3組", "14步", "休息1分鐘"),
